#!/bin/sh
set -e
# Code generated by godownloader on 2021-02-12T11:19:07Z. DO NOT EDIT.
#

usage() {
  this=$1
  cat <<EOF
$this: download go binaries for traefik/assimilis

Usage: $this [-b] bindir [-d] [tag]
  -b sets bindir or installation directory, Defaults to ./bin
  -d turns on debug logging
   [tag] is a tag from
   https://github.com/traefik/assimilis/releases
